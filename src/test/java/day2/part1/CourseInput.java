...
public class CourseInput {
	...
	public Position toPosition() {
		return switch (getDirection()) {
			case UP -> new Position(0, UP.getMultiplier() * getPower());
			case DOWN -> new Position(0, DOWN.getMultiplier() * getPower());
			case FORWARD -> new Position(FORWARD.getMultiplier() * getPower(), 0);
		};
	}
